...
public class CategoryDao {
    ...
    public void insertCategory(Category data) {
        String sql = "insert into category(category_id, department_id, name, description) values (:kodeid, :departmen, :name, :description)";
        MapSqlParameterSource map = new MapSqlParameterSource();
    ...
    public class RowMapperInner implements RowMapper<Category> {
        ...
        public Category mapRow(ResultSet rs, int rowNum) throws SQLException {
            ...
            data.setCategory_id(rs.getString("category_id"));
            data.setDepartment_id(rs.getString("department_id"));
